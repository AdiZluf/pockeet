      ...
      <View className="gap-2 pb-2">
        ...
        {options.map((option) => (
          <PressableScale
            ...
            className="min-h-[72px] flex-row items-center gap-4 rounded-2xl bg-surface-muted px-4 py-3.5"
          >
            ...
            <View className="min-w-0 flex-1 gap-0.5">
              <Text variant="bodyLg" align="start" className="font-semibold">
                {t(option.titleKey)}
              </Text>
        ...
        >
          <Text variant="label" muted className="font-semibold">
            {t("common.cancel")}
          </Text>
        </PressableScale>
      </View>
